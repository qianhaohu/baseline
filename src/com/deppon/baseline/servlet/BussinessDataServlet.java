...
import com.deppon.baseline.dao.BusinessDataDao;
 ...
 */
@WebServlet("/BussinessDataServlet")
public class BussinessDataServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public BussinessDataServlet() {
		super();
	...
	protected void service(HttpServletRequest request,
		...
		BusinessDataDao dao = new BusinessDataDao();

		List<BusinessDataBean> list = new ArrayList();
		// 实例数
		Integer instnum = 1;
		// 数组大小，初始化0
		int rows = 0;
		...
		for (int i = 0; i < list.size(); i++) {
			BusinessDataBean item = list.get(i);
